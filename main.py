...
def get_article_topics(product_name):
    try:
        ...
        prompt_additional = f'''Please show me this artcle as HTML format suitable for a WordPress post.
        And please give me only article.Please don't include another your explaination for this answer.
        ...
        Please don't use <article> tag and please try not to make the empty sector by <br> or line break.
        '''
